...
export function TableHeader({ variant, count }: TableHeaderProps) {
  ...
  return (
    <div className={`${bgColor} h-10 flex items-center pl-4 sm:pl-5 pr-2.5 rounded-t-lg`}>
      <div className="w-[200px] flex-shrink-0">
        <TableBadge count={count} variant={variant} />
      </div>
      <span
        className="font-sans font-semibold text-xs leading-5 uppercase flex-1 pl-4"
